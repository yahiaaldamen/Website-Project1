...
$conn = mysqli_connect($dbservername ,$dbusername, $dapassword,$dbname);
   ...
   $sql="SELECT *FROM guide WHERE User='$user' AND Password='$password'";
   $result=$conn->query($sql);
   if($result->num_rows>0){
    header("Location: guideDashbord.php");
    exit();
   }
   else{
        ...
        <div class="col-md-6 right-box">
          <div class="row align-items-center">
            <div class="header-text mb-4">
              <h2>Hello amazing guide</h2>
             
            </div>
            <form method="post" action="loginAsGuide.php">
