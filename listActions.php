...
<body>
    ...
    <a href="hotelBook.php" class="btn">Book a hotel? </a>
    <a href="guides.php" class="btn btn-primary">book a guide?</a>
    <a href="mainAfterLog.php" class="btn btn-secondary">Book a ticket</a>
    <a href="payment.php" class="btn btn-secondary">complete payment?</a>
  </div>
