      ...
      <div class="container">
        <div class="main-text">
          ...
          <div class="col-md-6 py-3 py-md-0">
            <form action="EuropePa.php" method="post">
              <input 
                list="pa"
                type="text"
                class="form-control"
...
<div class="container">
    ...
    <div class="row">
        ...
        $conn = mysqli_connect($dbservername ,$dbusername, $dapassword,$dbname);
           ...
           $sql="SELECT *FROM europepackages WHERE counrty ='$City' AND price='$pricee' AND Price <='$pricee';";
           $result=$conn->query($sql);
        ...
        if ($result->num_rows > 0) {
          echo'<h2>Avalible packages</h2>';
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo '<div class="card">';
                echo '<img src="./packages/'. $row["img"].'"  class="card-img-top" alt="' . $row["counrty"] . '">';
                echo '<div class="card-body">';
                echo '<h5 class="card-title">' . $row["counrty"] . '</h5>';
