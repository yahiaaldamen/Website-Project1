...
<html lang="en">
  ...
  <body>
    ...
    <section class="book" id="book">
      <div class="container">
        <div class="main-text">
          <h1><span>B</span>ook Hotel With Us!</h1>
        </div>

        <div class="row">
          <div class="col-md-6 py-3 py-md-0">
            <div class="card">
              <img src="./images/Bhotel.png" alt="" />
            </div>
          </div>
...
<div class="container">
    ...
    <div class="row">
        ...
        $conn = mysqli_connect($dbservername ,$dbusername, $dapassword,$dbname);
           ...
           $sql="SELECT *FROM hotels WHERE city ='$City' AND stars='$stars' AND Price <='$pricee';";
           $result=$conn->query($sql);
        ...
        if ($result->num_rows > 0) {
          echo'<h2>Avalible Hotels</h2>';

            while ($row = $result->fetch_assoc()) {
              
                echo '<div class="col-md-4 mb-4">';
                echo '<div class="card">';
                echo '<img src="./hotels/'. $row["photo"].'"  class="card-img-top" alt="' . $row["hotel_name"] . '">';
                echo '<div class="card-body">';
                echo '<h5 class="card-title">' . $row["city"] . '</h5>';
                echo '<h3 class="card-text">' . $row["hotel_name"] . '</h3>';
